...
--
-- Host: localhost
-- Generation Time: Aug 22, 2016 at 04:13 AM
...
CREATE TABLE `users` (
  ...
  `user_randSalt` varchar(255) NOT NULL DEFAULT '$2y$10$mynameishaozhuohuang22'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
(15, 'Vic', '$2y$10$mynameishaozhuohuang2uJlG0ekhAwDTT55RZCQsXcx5dOHFpsIW', 'Vic', 'Huang', 'vichuanghaozhuo@outlook.com', '', 'admin', '$2y$10$mynameishaozhuohuang22');
